...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.outparcelviewer = QtWidgets.QWidget(self.parcelTab)
        self.outparcelviewer.setGeometry(QtCore.QRect(0, 0, 1021, 531))
        self.outparcelviewer.setObjectName("outparcelviewer")
