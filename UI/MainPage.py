...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.OpenFileButton.setGeometry(QtCore.QRect(3, 3, 34, 34))
        ...
        self.OpenFileButton_2 = QtWidgets.QPushButton(self.fileTab)
        self.OpenFileButton_2.setGeometry(QtCore.QRect(37, 3, 34, 34))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Button, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.Window, brush)
        self.OpenFileButton_2.setPalette(palette)
        self.OpenFileButton_2.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("resurces/MainTab/SaveFile.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.OpenFileButton_2.setIcon(icon1)
        self.OpenFileButton_2.setIconSize(QtCore.QSize(30, 30))
