...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(1024, 833))
        MainWindow.setMaximumSize(QtCore.QSize(1024, 833))
        ...
        self.gridLayoutWidget_2 = QtWidgets.QWidget(self.frequencyResponceTab)
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(-1, -1, 1021, 531))
        self.gridLayoutWidget_2.setObjectName("gridLayoutWidget_2")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.gridLayoutWidget_2)
        self.gridLayout_2.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.FRWidget = GraphicsWiget(self.gridLayoutWidget_2)
        self.FRWidget.setEnabled(True)
        ...
        self.gridLayoutWidget_3 = QtWidgets.QWidget(self.probabilityOfProgrammingTab)
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(-1, -1, 1021, 531))
        self.gridLayoutWidget_3.setObjectName("gridLayoutWidget_3")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.gridLayoutWidget_3)
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.COPwidget = GraphicsWiget(self.gridLayoutWidget_3)
        self.COPwidget.setEnabled(True)
        self.COPwidget.setObjectName("COPwidget")
        self.gridLayout_3.addWidget(self.COPwidget, 0, 0, 1, 1)
        ...
        self.okButton.setGeometry(QtCore.QRect(390, 32, 131, 21))
        self.okButton.setFocusPolicy(QtCore.Qt.WheelFocus)
        self.okButton.setObjectName("okButton")
        self.label_11 = QtWidgets.QLabel(self.groupBox)
        self.label_11.setGeometry(QtCore.QRect(270, 10, 111, 16))
        self.label_11.setObjectName("label_11")
        self.timeEdit = QtWidgets.QDoubleSpinBox(self.groupBox)
        self.timeEdit.setGeometry(QtCore.QRect(270, 30, 111, 22))
        self.timeEdit.setMinimum(0.1)
        self.timeEdit.setMaximum(14000.0)
        self.timeEdit.setSingleStep(0.1)
        self.timeEdit.setProperty("value", 0.1)
        self.timeEdit.setObjectName("timeEdit")
        self.okStartButton = QtWidgets.QPushButton(self.groupBox)
        self.okStartButton.setGeometry(QtCore.QRect(530, 30, 141, 23))
        self.okStartButton.setObjectName("okStartButton")
...
"формирования КИП"))
        ...
        self.okButton.setText(_translate("MainWindow", "Создать посылку"))
        self.label_11.setText(_translate("MainWindow", "Время подрыва"))
        self.timeEdit.setSuffix(_translate("MainWindow", " мс"))
        self.okStartButton.setText(_translate("MainWindow", "Создать и отправить"))
